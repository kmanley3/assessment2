...
let employee1 = new Employee('Jess', 'weekday mornings, weekday afternoons')
...
class Manager extends Employee {
    constructor(name, shifts, underlings){
        super(name, shifts);
        this.underlings = underlings;
    }
    getEmployees(){
        console.log(`${this.name} manages ${this.underlings}.`)
    }
    addEmployee(emp){
        this.underlings.push(emp)
    }
}
